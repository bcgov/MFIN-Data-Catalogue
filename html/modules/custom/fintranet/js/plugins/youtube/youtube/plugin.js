	...
	CKEDITOR.plugins.add('youtube', {
		...
		init: function (editor) {
			...
			editor.ui.addButton('Youtube', {
				...
				toolbar : 'insert',
				command : 'youtube',
				icon : this.path + 'images/icon-hdpi.png'
			});

			CKEDITOR.dialog.add('youtube', function (instance) {
				var video,
				// Custom disabled fields.
					disabled = editor.config.youtube_disabled_fields || ['txtEmbed', 'txtWidth', 'txtHeight', 'chkResponsive', 'chkRelated', 'chkPrivacy', 'chkNoEmbed', 'chkOlderCode', 'chkAutoplay', 'chkControls'];
