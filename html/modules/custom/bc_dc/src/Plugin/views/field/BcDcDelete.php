...
/**
 * Field handler to delete button .
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("bc_dc_delete")
 */
class BcDcDelete extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    $options = [
      'attributes' => [
        ...
        'title' => $this->t('Delete @title', ['@title' => $node->getTitle()]),
      ],
      'query' => [
    ...
    $url = Url::fromRoute('entity.node.delete_form', ['node' => $node->id()], $options);
    $text = $this->t('Delete');
